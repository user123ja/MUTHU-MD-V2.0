...
case 'dare':
    ...
    "breakup with your best friend for 5hrs without telling him/her that its a dare",
     ...
     "send abusive words in any grup, excepting this grup, and send screenshot proof here"
              ...
              buffer = await getBuffer(`https://i.ibb.co/WGGxrdZ/TS.jpg`)
...
case 'menu': {
    ...
    let buttonMessage = {
    image: { url: `https://i.ibb.co/WGGxrdZ/TS.jpg` },
    caption: `╔═══════✪「 OWNER 」	
    ╠●  ${prefix}self
    ╠●  ${prefix}public
    ╠●  ${prefix}antitag
